...
public class SettingsUI : MonoBehaviour
{
    ...
    private Image _blackBackgrounImage;

    private void Awake()
    {
        _blackBackgrounImage = _blackBackgroundObject.GetComponent<Image>();
    ...
    private void OnSettingsButtonClicked()
    {
        ...
        _blackBackgrounImage.DOFade(0.8f, _animationDuration).SetEase(Ease.Linear);
    ...
    private void OnResumeButtonClicked()
    {
        ...
        _blackBackgrounImage.DOFade(0f, _animationDuration).SetEase(Ease.Linear);
